...
})({"4cDaG":[function(require,module,exports,__globalThis) {
...
},{}],"7SwCM":[function(require,module,exports,__globalThis) {
var _connectJs = require("@stripe/connect-js");
...
signUpButton.onclick = async ()=>{
    ...
    fetch("/account", {
        ...
        const instance = (0, _connectJs.loadConnectAndInitialize)({
...
},{"@stripe/connect-js":"iU9fo"}],"iU9fo":[function(require,module,exports,__globalThis) {
/* eslint-disable @typescript-eslint/no-empty-function */ /* eslint-disable @typescript-eslint/no-unused-vars */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "loadConnectAndInitialize", ()=>loadConnectAndInitialize);
...
const injectScript = ()=>{
    ...
    if (!head) throw new Error("Expected document.head not to be null. Connect.js requires a <head> element.");
...
const loadScript = ()=>{
    ...
    stripePromise = new Promise((resolve, reject)=>{
        ...
        if (window.StripeConnect) console.warn(EXISTING_SCRIPT_MESSAGE);
        ...
        try {
            ...
            if (script) console.warn(EXISTING_SCRIPT_MESSAGE);
            else if (!script) script = injectScript();
    ...
    return {
        create: (tagName)=>{
            ...
            if (hasCustomMethod(tagName)) {
                ...
                for(const method in methods)element[method] = function(value) {
...
},{}]},["4cDaG","7SwCM"], "7SwCM", "parcelRequire94c2")
